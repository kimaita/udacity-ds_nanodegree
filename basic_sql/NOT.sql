...
/*Use the accounts table to find all the companies whose names do not start with
 'C'.*/
SELECT
        name
FROM
...
/*Use the accounts table to findAll companies whose names do not contain the
...
/*Use the accounts table to findAll companies whose names do not end with 's'.*/
SELECT
        name
FROM
        accounts
