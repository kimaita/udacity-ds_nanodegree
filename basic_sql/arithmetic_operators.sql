...
SELECT
        id,
        account_id,
        standard_amt_usd / standard_qty AS std_unit_price
FROM
        orders
LIMIT
        10;
...
/* Write a query that finds the percentage of revenue that comes from poster
 ...
 question. This occurs because at least one of the values in the data creates a
 division by zero in your formula. There are ways to better handle this. For now,
 you can just limit your calculations to the first 10 orders, as we did in
